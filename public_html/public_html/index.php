...
<span class="icon-bar"></span>
    ...
    <div class="collapse navbar-collapse" id="myNavbar" style="color:white,background: #43a286">
      <ul class="nav navbar-nav navbar-right" style="color:white,background: #43a286">
        ...
        <li><a style="color:white,background: #43a286" href="gallery.php">GALLERY</a></li>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel" style="height:50%">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="images/main_page_carousel_image_1.png" alt="Image">
 ...
 <div class="item">
        <img src="images/main_page_carousel_image_2.png" alt="Image">
        <div class="carousel-caption">
          <h3>Love</h3>
          <p>to study</p>
        </div>      
      ...
      <div class="item">
        <img src="images/main_page_carousel_image_3.png" alt="Image">
        <div class="carousel-caption">
          <h3></h3>
          <p></p>
        </div>      
      ...
      <div class="item">
        <img src="images/main_page_carousel_image_4.png" alt="Image">
        <div class="carousel-caption">
          <h3>Draw</h3>
...
<center>
<div class="g" >             
  <img src="images/what_we_do.png" class="img-responsive d5"  alt="what we do ">      
</div>
</center>
	...
	<div class="flex-row row">
		...
		<div class="col-xs-6 col-sm-4 col-lg-4">
			<div class="thumbnail " style="background-color:#6dc756">
								<img  src="images/services_teaching_i.jpg" class="w3-circle" style="width:100%">
...
<p class="flex-text text-muted" style="color:white; text-align:justify">
		...
		<div class="col-xs-6 col-sm-4 col-lg-4 ">
			<div class="thumbnail "style="background-color:#009c7f">
								<img src="images/services_donation_ii.jpg" class="w3-circle">
				<div class="caption" style="color:white">
...
One man's trash is another man's treasure. Our needy children get donations every month from the privileged section. You never know, a pen to you, is worth a career to another.
		...
		<div class="col-xs-6 col-sm-4 col-lg-4">
			<div class="thumbnail " style="background-color:#7686b1">
							<img src="images/services_ending_menace_iii.jpg" style="width:100%" class="w3-circle">
				<div class="caption" style="color:white">
	...
	<div class="flex-row row">
		...
		<div class="col-xs-6 col-sm-4 col-lg-4">
			<div class="d2" style="margin-bottom:5px">
								<img  src="images/education_1.jpg">
...
<center><h3                   style="background:#43a286;color:white" >           WE CARE   </h3>		</center>
		...
		<div class="col-xs-6 col-sm-4 col-lg-4">
			<div class="d2" style="margin-bottom:5px">
								<img src="images/education_3.jpg">
