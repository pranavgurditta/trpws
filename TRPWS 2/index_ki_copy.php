...
<div style="width:100%" >
<script  src="https://infograph.venngage.com/js/embed/v1/embed.js" data-vg-id="284647" data-title="Creative Process" data-w="816" data-h="1056"></script>
</div>

<div class="container" >
<center><h2>ACTIVITIES @ TRPWS</h2></center>
		...
		<div class="col-xs-6 col-sm-4 col-lg-4">
			<div class="thumbnail " style="background-color:brown">
				...
				<div class="caption" style="color:white">
					<u><h3>  Teaching   </h3></u>
<p class="flex-text text-muted" style="color:white">
We help kids to choose the right path by the teachings we impart to them. We plan to make them self reliable by our teachings.
		...
		<div class="col-xs-6 col-sm-4 col-lg-4 ">
			<div class="thumbnail "style="background-color:green">
								<img src="b.jpg">
				<div class="caption" style="color:white">
					<u><h3>Art and craft</h3></u>
					<p class="flex-text text-muted"  style="color:white">
We provide them motivation and confidence to continue in their field of creativity and  become good artists and good craftsmen.
		...
		<div class="col-xs-6 col-sm-4 col-lg-4">
			<div class="thumbnail " style="background-color:blue">
							<img src="q.jpg" style="width:100%">
				<div class="caption" style="color:white">
				<u>	<h3>Exhibitions and Picnics</h3></u>
					<p class="flex-text text-muted" style="color:white">
All work and no play makes Jack a dull boy , alas we not only them learn through books but through experiences and games too.
